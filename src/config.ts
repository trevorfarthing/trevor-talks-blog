...
export const siteConfig: SiteConfig = {
  // Site Information
  // [CONFIG:SITE_URL]
  site: "https://trevor-talks.netlify.app",
  // [CONFIG:SITE_TITLE]
  title: "Trevor Talks",
  // [CONFIG:HOMEPAGE_TITLE]
  homepageTitle: "",
  // [CONFIG:SITE_DESCRIPTION]
  description: "One guy's takes on travel, tech, and the stuff in between.",
  // [CONFIG:SITE_AUTHOR]
  ...
  // Global Settings
  // [CONFIG:THEME]
  theme: "obsidian", // Available themes: "minimal" | "oxygen" | "atom" | "ayu" | "catppuccin" | "charcoal" | "dracula" | "everforest" | "flexoki" | "gruvbox" | "macos" | "nord" | "obsidian" | "rose-pine" | "sky" | "solarized" | "things" | "custom"
  ...
  fonts: {
    ...
    families: {
      // [CONFIG:FONT_BODY]
      body: "Fira Code", // Body text font family
      // [CONFIG:FONT_HEADING]
  ...
  navigation: {
    ...
    social: [
      {
        title: "Instagram",
        url: "https://instagram.com/trevor_farthing",
        icon: "instagram",
      },
      {
        title: "GitHub",
        url: "https://github.com/trevorfarthing",
        icon: "github",
      },
    ],
  },
